...
from munl.unlearning.scrub_utils import fgk_finetune
from munl.utils import DictConfig, get_num_classes_from_model


class ForgettingGammaK(BaseUnlearner):
...
@dataclass
class DefaultForgettingGammaKConfig:
    num_epochs: int = ForgettingGammaK.ORIGINAL_NUM_EPOCHS
    batch_size: int = ForgettingGammaK.ORIGINAL_BATCH_SIZE
    num_blocks: int = ForgettingGammaK.ORIGINAL_NUM_BLOCKS
    learning_rate: float = ForgettingGammaK.ORIGINAL_LR
    sgda_learning_rate: float = ForgettingGammaK.ORIGINAL_SGDA_LR
    sgda_decay_rate: float = ForgettingGammaK.ORIGINAL_LR_DECAY_RATE
    sgda_weight_decay: float = ForgettingGammaK.ORIGINAL_SGDA_WEIGHT_DECAY
