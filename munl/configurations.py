...
@dataclass
@unlearner_store(name="catastrophic_forgetting_gamma_k")
class CFGKUnlearner:
    from munl.unlearning.catastrophic_forgetting_gamma_k import DefaultForgettingGammaKConfig

    _target_: str = "munl.unlearning.ForgettingGammaK"
    cfg: DefaultForgettingGammaKConfig = field(default_factory=DefaultForgettingGammaKConfig)
    device: str = DEFAULT_DEVICE

@dataclass
@unlearner_store(name="rurk")
class RURKUnlearnerConf:
    from munl.unlearning.rurk import DefaultRURKConfig

    _target_: str = "munl.unlearning.RURKUnlearner"
